# Administration du marché et votes — 0.19.0-beta.3
...
5. À chaque dépôt public terminé, le candidat reçoit sa confirmation et les administrateurs actifs de l’édition reçoivent le dossier. En votes multiples, les votants actifs le reçoivent aussi. Le premier administrateur actif du tableau sert d’adresse de réponse des candidats. Le champ email organisateur indépendant est supprimé. Une ancienne édition conserve son ancien contact, ou à défaut l’email d’administration du site, jusqu’à l’enregistrement de sa nouvelle équipe ; cet ancien contact ne reçoit aucun droit automatiquement. Les simples téléversements de pièces ne déclenchent pas ces notifications.
...
- Résultat du 16 septembre 2026 : **96 vérifications d’intégration réussies**, dont les permissions de publication et suppression, la création des administrateurs, les deux tableaux, la conservation des notes lors d’une promotion, la séparation des notifications en modes simple/multiple, les invitations et les contrôles de votes existants. Vérification navigateur complémentaire sur le site local avec le rôle administrateur marché. Les comptes et dossiers fictifs sont retirés après vérification.
...
- Bêta installable : `C:\Users\paul\Projects\MarchePotier\dist\marche-potier-0.19.0-beta.3.zip`.
